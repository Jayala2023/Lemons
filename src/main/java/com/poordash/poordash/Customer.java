...
public class Customer{
    ...
    public String toString(){
        return "username: " + getUsername() + " password: " + getPassword() + " firstName: " + getFirstName()
                + " lastName: " + getLastName() + " email: " + getEmail() + " phone: " + getPhone() + " address: " +
                getAddress() + " city: " + getCity() + " state: " + getState() + " zip: " + getZip();
    }

    public boolean countContains(String regex, String strPassword) {
        int count = 0;
